    ...
    <div class="container">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="venue">a.	Clarity of information on the requirements  :</label>
                    ...
                    <div class="col-md-6">
                        <label for="organization">b.	Adequate time given to prepare the requirements          </label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="speakers">c.	Effectiveness of interview screening conducted:</label>
                    ...
                    <div class="col-md-6">
                      <label for="speakers">d.	Assistance in the preparation of documents:</label>
                      <select class="form-control" id="speakers">
                        <option>O – Outstanding</option>
                        <option>VS – Very Satisfactory</option>
                        <option>S – Satisfactory</option>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <label for="speakers">e.	Schedule in the submission of requirement:</label>
                    <select class="form-control" id="speakers">
                      <option>O – Outstanding</option>
                      <option>VS – Very Satisfactory</option>
                      <option>S – Satisfactory</option>
                ...
                <div class="col-md-6">
                  <label for="speakers">f.	Accreditation of Student Organization based on standard requirements: </label>
                  <select class="form-control" id="speakers">
                    <option>O – Outstanding</option>
                    <option>VS – Very Satisfactory</option>
                    <option>S – Satisfactory</option>
              ...
              <h5>V. Efficiency in the delivery of the following personnel:</h5>
                ...
                <input type="text" class="form-control" id="event" placeholder="Enter the event name" required>
            </div>
          </div>
        </div>
        <hr>
